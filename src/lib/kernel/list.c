...
/* Inserts ELEM at the beginning of LIST, so that it becomes the
   front in LIST. */
void
list_ins_front (struct list *list, struct list_elem *elem)
{
...
/* Inserts ELEM at the end of LIST, so that it becomes the
   back in LIST. */
void
list_ins_back (struct list *list, struct list_elem *elem)
{
...
/* Removes ELEM from its list and returns the element that
   ...
   while (!list_empty (&list))
     {
       struct list_elem *e = list_rem_front (&list);
       ...do something with e...
     }
*/
struct list_elem *
...
struct list_elem *
list_rem_front (struct list *list)
{
...
/* Removes the back element from LIST and returns it.
   Undefined behavior if LIST is empty before removal. */
struct list_elem *
list_rem_back (struct list *list)
{
